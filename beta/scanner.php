<?
	...
	{																
		...
		//	$excludeFiles = array();
				...
				{					
					...
					{																													
						...
						{																					
							...
							{								
								$icon_type = strtoupper($fileExtension);									
							}
			...
			// ”дал€ем из списка файлы, запрещенные дл€ отображени€
		}		
		else
		{
			...
			{	
				...
				{																
					...
					{																							
						...
						if(strtolower(trim($defUrlInfo[0])) == $DIR_TAG_DEFAULT)
						{							
	...
	{			
		return (implode($outDelim, explode($inDelim, $path)));
	}
